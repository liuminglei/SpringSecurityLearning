...
/**
 * Abstract processor of browser-based HTTP-based captcha-based authentication requests.
 *
 ...
 * @author luas
 */
public abstract class AbstractCaptchaAuthenticationProcessingFilter extends GenericFilterBean
     ...
     */
    protected AbstractCaptchaAuthenticationProcessingFilter(String defaultFilterProcessesUrl) {
     ...
     */
    protected AbstractCaptchaAuthenticationProcessingFilter(
    ...
    /**
     * Performs captcha authentication.
     * <p>
     * The implementation should do one of the following:
     * <ol>
     * <li>nothing to do indicating successful authentication</li>
     * <li>Throw an <tt>EmptyCaptchaAuthenticationException</tt> if the captcha is null</li>
     * <li>Throw an <tt>BadCaptchaAuthenticationException</tt> if the captcha is invalid</li>
     * </ol>
     *
     ...
     */
    public abstract void captchaAuthentication(HttpServletRequest request) throws AuthenticationException, IOException,
            ServletException;
